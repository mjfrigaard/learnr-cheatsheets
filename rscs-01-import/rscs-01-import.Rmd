...
knitr::include_graphics(path = "https://raw.githubusercontent.com/mjfrigaard/csuc-data-jounalism-learnr/main/cheatsheets/rscs-01-import/www/excel-data-export.png")
```
...
writeDataTable(wb = workbook, sheet = "file-02.csv", x = excel_data$f2.csv)
writeDataTable(wb = workbook, sheet = "file-01.csv", x = excel_data$f1.csv)
writeDataTable(wb = workbook, sheet = "file-03.csv", x = excel_data$f3.csv)
...
knitr::include_graphics(path = "https://raw.githubusercontent.com/mjfrigaard/csuc-data-jounalism-learnr/main/cheatsheets/rscs-01-import/www/openxlsx-export.png")
```
...
knitr::include_graphics(path = "https://raw.githubusercontent.com/mjfrigaard/csuc-data-jounalism-learnr/main/cheatsheets/rscs-01-import/www/gs4-data.png")
```
...
All of the information in this tutorial is on the cheatsheet from RStudio, which you can access here. If you'd like the data files used in this tutorial, you can download them from the Github repo.  
