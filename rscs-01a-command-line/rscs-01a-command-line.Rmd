...
All command-line tools are designed to be modular, which means they work in concert with one another. In the example above we downloaded the book Moby-Dick into our local `data/` folder in a file named, `moby-dick.txt`. 

What if we wanted to count how many times the name `Ahab` occurs in this file? 
